...
public class HibernateConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory(){
		...
		props.getProperty("hibernate.dialect", HIBERNATE_DIALECT);
		props.getProperty("hibernate.showsql", HIBERNATE_SHOW_SQL);
		props.getProperty("hibernate.hbm2ddl.auto", HIBERNATE_HBM2DDL_AUTO);
